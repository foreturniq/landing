...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2.2fr] gap-12 lg:gap-20">
          <div className="lg:pt-2">
            ...
            <p className="text-gray-500 mt-4 leading-relaxed text-sm max-w-[34ch]">
              Four direct effects on the numbers that matter to an F&amp;B
              operation.
            </p>
          </div>
      ...
      <section className="border-t border-slate-100 px-8 py-32">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            ...
            <p className="text-gray-500 mt-4 text-sm leading-relaxed max-w-[46ch]">
              Every feature currently in the product, relevant to running a
              course.
            </p>
          </div>
