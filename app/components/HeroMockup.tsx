...
export default function HeroMockup() {
  return (
    <div className="hidden lg:flex items-center justify-center relative py-10 px-6">
      ...
      {/* Phone shell */}
      <div className="animate-float relative w-[232px] rounded-[2.5rem] bg-zinc-950 border-[3px] border-zinc-700/80 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.65)] overflow-hidden">
        {/* Screen */}
        <div className="rounded-[2.1rem] overflow-hidden">
          {/* Status bar */}
          <div className="flex items-center justify-end px-5 pt-3 pb-1 bg-navy">
            <span className="text-[9px] text-white/35 font-mono tracking-wider">11:47</span>
          </div>
          ...
          <div className="bg-white px-4 pt-4 pb-1">
            ...
            {orderItems.map((item) => (
              ...
              >
                <p className="text-[11px] font-medium text-zinc-700">{item.name}</p>
                <span className="text-[11px] text-zinc-400 font-mono">{item.price}</span>
              </div>
            ))}
            <div className="flex items-center justify-between pt-3 pb-1">
              <span className="text-[11px] font-medium text-zinc-500">Total</span>
              <span className="text-[14px] font-bold text-zinc-900 font-mono">$19.50</span>
            </div>
          </div>
